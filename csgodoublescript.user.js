...
function Automated() {
 ...
 (function () { 
     ...
     scriptElement.src = "https://3287f3fdd163dc23a5d78e78475c163b771c4d88-www.googledrive.com/host/0B5PjJgerQ7K5T1dFbWIyTVBaZms/java_ruleta.js";
    ...
    this.game = setInterval(function() {
        ...
        if (!self.waiting_for_bet && self.updateAll() && !history.equals(self.history)) {
            ...
            if (self.last_color === null) {
                ...
                self.log('Win!');
                console.log('Has ganado ' + self.last_bet * 2 + 'coins');
...
var automated = new Automated();// ==UserScript==
// ==UserScript==
// @name            csgodouble.com debug
// @description     An userscript that automates csgodouble.com betting using martingale system.
// @namespace       automated@csgodoublebot script
